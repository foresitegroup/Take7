...
define('LOGOUT_URL', 'http://www.take7pro.com');
...
<form method="post" class="login" style="text-align: center;">
  <div style="width: 60%; margin: 0 auto;">
    ...
    <input type="password" name="access_password" id="access_password" placeholder="Password"> <input type="submit" name="Submit" value="LOGIN">
    <br><br>
  </div>
</form>
